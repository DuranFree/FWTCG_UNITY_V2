...
namespace FWTCG.UI
{
        ...
        IPointerExitHandler
    {
        ...
        private void Awake()
        {
            ...
            sweepRT.anchorMin = new Vector2(0f, 0f);
            sweepRT.anchorMax = new Vector2(0f, 1f);
            sweepRT.pivot     = new Vector2(0f, 0.5f);
            sweepRT.offsetMin = Vector2.zero;
            sweepRT.offsetMax = Vector2.zero;
            sweepRT.sizeDelta = new Vector2(_rt.rect.width * SWEEP_WIDTH_FACTOR, 0f);

            // Start hidden (off the left edge)
            sweepRT.anchoredPosition = new Vector2(-_rt.rect.width, 0f);
        }
        ...
        private IEnumerator SweepRoutine()
        {
            ...
            while (t < DURATION)
            {
                ...
                sweepRT.anchoredPosition = new Vector2(x, 0f);
                yield return null;
            }

            // Reset off-screen
            sweepRT.anchoredPosition = new Vector2(-btnWidth, 0f);
