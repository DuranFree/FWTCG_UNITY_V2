...
namespace FWTCG.Tests.EditMode
{
    ...
    public class VFX4ResolverTests
    {
        ...
        public void Refresh_DamageTaken_TurnsAtkTextYellow()
        {
            ...
            atkTextGo.transform.SetParent(go.transform);
            atkTextGo.AddComponent<RectTransform>();
            ...
            unit.CurrentHp = 1;
            cv.Refresh();
            Assert.AreEqual(Color.yellow, atkText.color, "After damage, color should be yellow");
        ...
        public void Refresh_FullHpRestore_ReturnsAtkTextToWhite()
        {
            ...
            unit.CurrentHp = 1;
            cv.Refresh();
            Assert.AreEqual(Color.yellow, atkText.color);

            unit.CurrentHp = card.Atk;
            cv.Refresh();
            Assert.AreEqual(Color.white, atkText.color, "Restored HP should return to white");
